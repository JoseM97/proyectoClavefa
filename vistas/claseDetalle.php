        ...
        <main>
            <section>
                ...
                <article class="espacioItem">
                    <?php
                        if(isset($_POST["btnDetalleClase"])){

                            $consulta="select * from clases where idClase=".$_POST["datoGuardar"];
                                        ...
                                        <div class="retener2">
                                            ...
                                            <div class="datosItem">
                                                    <form method="post" action="index.php">
                                                        ...
                                                        <p><strong>Fecha y horario: </strong><?php echo $datos["fecha"] ?></p>
                                                        
                                                        <p class="card-text"><strong>Tipo de clase: </strong><?php echo $datos["tipoClase"] ?></p>
                                                        <p><strong>Descripción:</strong></p>
                                                        <p class="card-text"><?php echo $datos["descripcion"] ?></p>
                                                        <input class="ocul" type="text" name="datoGuardar" id="datoGuardar" value="<?php echo $datos["fecha"] ?>"/>
