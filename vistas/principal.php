    ...
    <body>
        ...
        <main>
            <section>
                ...
                <div>
                    <picture>
                        <source class="ima" media="(min-width: 1500px)" srcset="images/1a.jpg" alt="menu" width="100%">
                        <img class="ima" src="images/1.jpg" alt="menu" width="100%">
                    </picture>
                </div>
                ...
                <div>
                    <picture>
                        <source class="ima" media="(min-width: 1500px)" srcset="images/2a.jpg" alt="menu" width="100%">
