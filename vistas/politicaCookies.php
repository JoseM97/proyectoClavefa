    ...
    <body>
        ...
        <main>
            <section>
                ...
                <div>
                    <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Duis lacus nulla, 
                        congue sed auctor sagittis, elementum non nulla. Morbi vel sapien non mauris
                        tincidunt condimentum quis et ligula. Aenean nec pretium nulla. Etiam cursus,
                        lectus ut varius tincidunt, sem lorem porttitor orci, vitae placerat magna
                        lectus sit amet nisl. Phasellus egestas, tellus in accumsan vulputate,
                        nulla enim ultrices justo, ac consectetur libero ipsum nec tellus.
                    </p>
                </div>
                <div class="soloTexto">
                    <p>
                        Pellentesque condimentum ipsum ipsum, id faucibus mauris viverra at.
                        Pellentesque venenatis metus quis ante varius, in scelerisque magna
                        porttitor. Sed odio enim, suscipit vel sollicitudin et, volutpat vitae ex.
                        Suspendisse consectetur aliquam pellentesque. Integer nisl sem, ornare at 
                        libero sed, ultrices placerat tortor. Aenean scelerisque volutpat ex,
                        quis aliquet felis pretium non. Duis quis sem lacus. Praesent faucibus
                        at lectus in commodo.
