        ...
        <main>
            <section>
                ...
                <article class="espacioItem">
                    <?php
                        if(isset($_POST["btnDetalleProdu"])){

                            $consulta="select * from productos where idProdu=".$_POST["datoGuardar"];
                            ...
                            if($resultado){
                                    ...
                                    ?>
                                        <div class="retener2">
                                            <div class="imagenItem">
                                                <img src="<?php echo $datos["url"] ?>" class="card-img-top" alt="<?php echo $datos["nombre"] ?>">
                                                
                                            </div>
                                            <div class="datosItem">
                                                    <form method="post" action="index.php">
                                                        <h5 class="card-title"><strong><?php echo $datos["nombre"] ?></strong></h5>
                                                        <p class="card-text"><strong>Precio: </strong><?php echo $datos["precio"] ?>€</p>
                                                        
                                                        <p><strong>Color: </strong><?php echo $datos["color"] ?></p>
                                                        
                                                        <p class="card-text"><strong>Tipo: </strong><?php echo $datos["tipo"] ?></p>
                                                        
                                                        <p><strong>Stock: </strong><?php echo $datos["stock"] ?></p>
                                                        
                                                        <p><strong>Descripción:</strong></p>
                                                        <p class="card-text"><?php echo $datos["descrip"] ?></p>
                                                        <input class="ocul" type="text" name="datoGuardar" id="datoGuardar" value="<?php echo $datos["nombre"] ?>"/>
                                ...
                                $mensaje_error="Imposible conectar. Error número: " . mysqli_errno($conexion) . ":" . mysqli_error($conexion);
