                ...
                <article class="espacioItem">
                        ...
                        <form action="index.php" method="POST">
                            <div class="buscar">
                                <div>
                                    ...
                                    <input class="btn btn-danger" type="submit" name="search" id="search" value="Buscar">
                                </div>
                                <div>
                    ...
                    <?php
                        if(isset($_POST["search"])){
                            ...
                            if($_POST['order'] == "DESC"){
                                $query = "select * from productos WHERE nombre LIKE '%" . $keywords . "%' order by precio DESC";
                            }elseif($_POST['order'] == "ASC"){
                                $query = "select * from productos WHERE nombre LIKE '%" . $keywords . "%' order by precio ASC";
                            }else{
                                $query = "select * from productos WHERE nombre LIKE '%" . $keywords . "%' order by tipo";
                            }
